        ...
        <div className="flex flex-col min-h-screen">
            ...
            <div className="grid grid-cols-1 gap-8 px-4 mb-16 md:grid-cols-3">
                <div className="flex flex-col items-center p-8 text-center transition duration-300 bg-white border border-gray-100 shadow-sm rounded-2xl hover:-translate-y-1">
                    ...
                    <p className="text-sm leading-relaxed text-gray-500">Secure your tickets instantly with our lightning-fast booking experience designed for convenience.</p>
                </div>
                <div className="flex flex-col items-center p-8 text-center transition duration-300 bg-white border border-gray-100 shadow-sm rounded-2xl hover:-translate-y-1">
                    <div className="flex items-center justify-center w-16 h-16 mb-6 text-2xl text-white bg-gray-900 shadow-md rounded-2xl shadow-gray-200/50">
                        <FaTicketAlt />
                    ...
                    <p className="text-sm leading-relaxed text-gray-500">Access, manage, and download your tickets anytime directly from your personalized dashboard.</p>
                </div>
                <div className="flex flex-col items-center p-8 text-center transition duration-300 bg-white border border-gray-100 shadow-sm rounded-2xl hover:-translate-y-1">
                    <div className="flex items-center justify-center w-16 h-16 mb-6 text-2xl text-white bg-gray-900 shadow-md rounded-2xl shadow-gray-200/50">
                        <FaShieldAlt />
                    ...
                    <p className="text-sm leading-relaxed text-gray-500">Your registrations and transactions are protected with advanced security and OTP verification.</p>
                </div>
            </div>
            ...
            <footer className="pt-16 pb-8 mt-auto text-center border-t border-gray-200">
                ...
                <p className="max-w-md mx-auto mb-6 text-sm text-gray-500">
                    Discover, manage, and host unforgettable events with a modern platform built for seamless experiences.
                </p>
                <div className="text-xs font-medium tracking-wider text-gray-400 uppercase">
                    &copy; {new Date().getFullYear()} © 2026 EVENTORA. ALL RIGHTS RESERVED.
                </div>
            </footer>
        </div>
    );
