...
const users = [
    { name: 'Admin User', email: 'admin@eventbookease.com', password: 'password123', role: 'admin' },
    { name: 'Demo User', email: 'user@eventbookease.com', password: 'password123', role: 'user' },
    { name: 'Alice Smith', email: 'alice@eventbookease.com', password: 'password123', role: 'user' },
    { name: 'Bob Johnson', email: 'bob@eventbookease.com', password: 'password123', role: 'user' },
    { name: 'Charlie Dave', email: 'charlie@eventbookease.com', password: 'password123', role: 'user' },
    { name: 'Diana Prince', email: 'diana@eventbookease.com', password: 'password123', role: 'user' },
    { name: 'Ethan Hunt', email: 'ethan@eventbookease.com', password: 'password123', role: 'user' },
    { name: 'Fiona Gallagher', email: 'fiona@eventbookease.com', password: 'password123', role: 'user' },
    { name: 'George Miller', email: 'george@eventbookease.com', password: 'password123', role: 'user' },
    { name: 'Hannah Montana', email: 'hannah@eventbookease.com', password: 'password123', role: 'user' }
];
...
const seedDatabase = async () => {
    try {
        await mongoose.connect(process.env.MONGO_URI || 'mongodb://localhost:27017/eventbookease');
        ...
        console.log('-------------------------------------------');
        console.log('Admin Email: admin@eventbookease.com');
        console.log('User Email:  user@eventbookease.com');
